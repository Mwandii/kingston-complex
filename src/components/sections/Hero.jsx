 ...
 * three photos on the other (room / conference hall / exterior) —
 * no single photo has to represent the whole business on its own.
 */
export default function Hero() {
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen bg-[color:var(--color-neutral-50)] flex items-center pt-24 pb-16 overflow-hidden"
    >
      <div
        aria-hidden="true"
